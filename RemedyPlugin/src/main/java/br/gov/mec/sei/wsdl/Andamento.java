...
public class Andamento  implements java.io.Serializable {
	...
	public String toString() {
		...
		builder.append("Andamento [idAndamento=");
		builder.append(idAndamento);
		builder.append(", idTarefa=");
		builder.append(idTarefa);
		builder.append(", idTarefaModulo=");
		builder.append(idTarefaModulo);
		...
		builder.append(Arrays.toString(atributos));
		builder.append("]");
