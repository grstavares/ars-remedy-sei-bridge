...
public class SeiServiceLocator extends org.apache.axis.client.Service implements SeiService {
    ...
    private java.lang.String SeiPortService_address = "http://hmg-sei3.mec.gov.br/sei/ws/SeiWS.php";
    ...
    public SeiPortType getSeiPortService() throws javax.xml.rpc.ServiceException {
    ...
    public SeiPortType getSeiPortService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            SeiBindingStub _stub = new SeiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (SeiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                SeiBindingStub _stub = new SeiBindingStub(new java.net.URL(SeiPortService_address), this);
                _stub.setPortName(getSeiPortServiceWSDDServiceName());
                return _stub;
            }
        }
